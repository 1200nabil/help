...
function openPopup(assignment) {
  ...
  <head>
    ...
    <title>edpuzzle answers for: ${media.title}</title>
  </head>
  <div id="header_div">
    <div>
  ...
  <hr>
  <p style="font-size: 12px">Credits to: <a target="_blank" href="https://github.com/ading2210">ading2210</a> on github | host: <a target="_blank" href="https://nabilgames.vercel.app">nabilgames</a></p>
